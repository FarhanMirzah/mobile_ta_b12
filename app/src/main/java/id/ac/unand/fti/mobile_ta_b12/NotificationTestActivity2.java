...
public class NotificationTestActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonShow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent resultIntent = new Intent(NotificationTestActivity2.this, ListLogbookActivity.class);
                TaskStackBuilder stackBuilder = TaskStackBuilder.create(NotificationTestActivity2.this);
                ...
                NotificationCompat.Builder builder = new NotificationCompat.Builder(NotificationTestActivity.this, CHANNEL_ID)
                        ...
                        .setContentTitle("Notifikasi Logbook")
                        .setContentText("Mahasiswa mengupdate Logbook")
//                        .setContentIntent(resultPendingIntent)
                        .addAction(R.drawable.ic_baseline_warning_24, "Lihat", resultPendingIntent)
        ...
        FirebaseMessaging.getInstance().getToken()
                .addOnCompleteListener(new OnCompleteListener<String>() {
                    ...
                    public void onComplete(@NonNull Task<String> task) {
                        ...
                        // Log and toast
                        Log.d(TAG, token);
                        Toast.makeText(NotificationTestActivity2.this, token, Toast.LENGTH_SHORT).show();
                    }
                });
    }
